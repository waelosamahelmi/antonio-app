...
Go to: https://github.com/waelosamahelmi/antonio-app/settings/secrets/actions
...
| `VITE_ANDROID_PACKAGE` | `com.pizzeria.antonio.admin` |
...
| `HOSTINGER_FTP_HOST` | `ftp.pizzeriaantonio.fi` |
| `HOSTINGER_FTP_USER` | `u608790032.pizzeriaantonio` |
| `HOSTINGER_FTP_PASSWORD` | `antonio@2025!` |
| `IMAGE_CDN_URL` | `https://images.pizzeriaantonio.fi` |
...
| `VITE_SMTP_PORT` | `587` |
| `VITE_SMTP_USER` | `no-reply@pizzeriaantonio.fi` |
| `VITE_SMTP_PASS` | `antonio@2025!` |
...
2. Check workflow at: https://github.com/waelosamahelmi/antonio-app/actions
